...
class CollegeList{
    constructor(global, utils){
        this.collegeList = document.getElementById('college-list')
        this.global = global
        this.utils = utils
    ...
    async getCollStudents(){
        ...
        const students = datas.map(data=>{
          ...
          this.collegeList.innerHTML = `${students}`
