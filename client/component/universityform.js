...
class UniversityForm{
   ...
   async handleUniSubmit(e){
      if (!this.uniForm.reportValidity()) return;
        e.preventDefault()
        const formData = new FormData(this.uniForm);
...
// formData.append("parentTell", this.uniForm.elements.parentTell.value);
    ...
    const maxSize = 300 * 1024
        ...
        const uniStudents = await newsAPI.postNews(formData, 'university-students', this.global)
